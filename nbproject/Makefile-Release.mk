...
${OBJECTDIR}/BusRoute.o: BusRoute.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BusRoute.o BusRoute.cpp
...
${OBJECTDIR}/RouteSegment.o: RouteSegment.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RouteSegment.o RouteSegment.cpp

${OBJECTDIR}/TimeTable.o: TimeTable.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TimeTable.o TimeTable.cpp
